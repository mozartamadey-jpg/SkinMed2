...
export default function SpiderVeinsClient() {
  ...
  const indications = [
    { title: "Сосудистые звездочки", desc: "Точечные расширения капилляров на лице (телеангиэктазии), напоминающие паутинку.", icon: "solar:atom-linear" },
    { title: "Купероз", desc: "Диффузное покраснение кожи и видимая сосудистая сетка, часто на щеках и крыльях носа.", icon: "solar:medical-kit-linear" },
    { title: "Р РѕР·Р°С†РµР°", desc: "Хроническое покраснение и воспаление кожи лица с расширенными сосудами.", icon: "solar:health-bold-duotone" },
    { title: "Гемангиомы", desc: "Доброкачественные сосудистые образования (красные родинки) различного размера.", icon: "solar:danger-triangle-linear" },
    { title: "Винные пятна", desc: "Врожденная патология развития сосудов, требующая деликатного лазерного лечения.", icon: "solar:waterdrop-linear" },
    { title: "Точечные капилляры", desc: "Единичные лопнувшие сосуды, портящие общий эстетический вид кожи.", icon: "solar:eye-linear" },
  ];

  const advantages = [
    { title: "Селективное воздействие", desc: "Лазерный луч поглощается только гемоглобином в сосуде, не повреждая и не перегревая окружающую здоровую кожу." },
    { title: "Моментальный эффект", desc: "Мелкие сосуды исчезают (\"склеиваются\") прямо во время проведения процедуры, крупные — бледнеют." },
    { title: "Без рубцов и шрамов", desc: "Процедура проводится без разрезов и проколов, что гарантирует абсолютное отсутствие следов вмешательства." },
    { title: "Комфорт и безопасность", desc: "Встроенная система охлаждения защищает эпидермис от ожогов и делает процедуру безболезненной." }
  ];

  const steps = [
    { title: "Консультация", desc: "Осмотр врача-дерматолога, оценка диаметра и глубины залегания сосудов, исключение противопоказаний." },
    { title: "Подготовка", desc: "Демакияж и очищение зоны обработки. Нанесение специального контактного геля для лучшего проникновения луча." },
    { title: "Лазерная обработка", desc: "Специалист проходит по сосудистой сетке на аппарате Clearlight IPL. Вы ощущаете лишь легкое покалывание и тепло." },
    { title: "Успокаивающий уход", desc: "Удаление геля, нанесение заживляющего крема (например, Пантенол) и солнцезащитного средства SPF 50." }
  ];

  const aftercare = [
    { title: "SPF защита", desc: "Избегайте прямых солнечных лучей и обязательно используйте SPF 50 перед выходом.", icon: "solar:sun-2-linear" },
    { title: "Без нагрева", desc: "Исключите посещение бани, сауны, горячих ванн и спортзала на 3-5 дней.", icon: "solar:temperature-linear" },
    { title: "Бережный уход", desc: "Не трите кожу жестким полотенцем, откажитесь от скрабов и спиртовых лосьонов.", icon: "solar:hand-stars-linear" },
    { title: "Заживляющий крем", desc: "Наносите рекомендованный врачом успокаивающий крем (Пантенол, Траумель) 2 раза в день.", icon: "solar:medical-kit-linear" }
  ];

  const faqData = [
    { q: "Сколько процедур нужно для полного удаления?", a: "Единичные мелкие сосуды и «звездочки» часто исчезают за 1 сеанс. Для лечения выраженного купероза или обширной сосудистой сетки потребуется курс из 3–5 процедур с интервалом 3–4 недели." },
    { q: "Это навсегда?", a: "Удаленные сосуды исчезают навсегда. Однако лазер не лечит причину слабости сосудистой стенки (наследственность, гормоны). Без правильного ухода со временем могут появиться новые сосуды." },
    { q: "Как выглядит кожа после процедуры?", a: "Сразу после сеанса возможно легкое покраснение (эритема) и небольшой отек, которые проходят в течение нескольких часов. Обработанный сосуд может немного потемнеть перед тем, как окончательно исчезнуть." },
    { q: "Больно ли удалять сосуды лазером?", a: "Процедура абсолютно терпима. Вспышка лазера ощущается как легкий горячий щелчок по коже. Благодаря мощной системе контактного охлаждения дискомфорт минимален." },
    { q: "В какое время года лучше проводить процедуру?", a: "Удаление сосудов на лице и открытых участках тела рекомендуется проводить в осенне-зимний период, когда солнце наименее активно, чтобы исключить риск пост-воспалительной пигментации." }
  ];
          ...
          <main className="w-full mt-12 sm:mt-16 flex flex-col gap-20 md:gap-32 pb-24">
            ...
            <section className="mb-[-2rem] reveal-up opacity-0">
              <div className="flex flex-wrap items-center gap-2 text-sm sm:text-base text-slate-500 font-light">
                ...
                <Icon icon="mdi:chevron-right" className="text-slate-400" />
                <span className="text-slate-700 font-medium">Удаление сосудов</span>
              </div>
            </section>
            ...
            <section className="reveal-up opacity-0 scroll-glow-item group">
              <div className="bg-[#050B14] rounded-[2rem] md:rounded-[3rem] p-8 md:py-16 md:px-20 min-h-[550px] md:min-h-[700px] relative overflow-hidden shadow-[0_2rem_5rem_-1rem_rgba(0,0,0,0.3)] flex items-center border border-white/10 group-[.mobile-glow-active]:shadow-[#60c2ff]/30 transition-all duration-700">
                <div className="absolute inset-0 z-0 overflow-hidden">
                  ...
                  <ServiceImage src="/images/spider-veins-hero-v2.png" alt="Удаление сосудистых звездочек" sizes="100vw" priority className="w-full h-full object-cover opacity-80 mix-blend-overlay scale-[1.02] md:group-hover:scale-[1.04] transition-transform duration-[2s]" />
                ...
                <div className="relative z-20 w-full max-w-4xl mt-auto md:mt-0 pt-32 md:pt-0">
                  <div className="inline-flex items-center gap-3 bg-[#60c2ff]/10 backdrop-blur-md text-[#60c2ff] px-5 py-2.5 rounded-full border border-[#60c2ff]/20 shadow-sm mb-6">
                    ...
                    <span className="text-xs sm:text-sm font-semibold uppercase tracking-widest text-white">Чистая кожа без покраснений</span>
                  </div>
                  ...
                  <h1 className="text-4xl md:text-6xl lg:text-[6rem] font-light text-white leading-[1.0] uppercase tracking-[-0.04em] drop-shadow-2xl mb-6">
                    Удаление <br/> <span className="font-serif italic text-[#60c2ff]/80">сосудов</span>
                  </h1>
                  
                  <p className="text-lg md:text-xl font-light text-slate-300 leading-relaxed max-w-2xl mb-8">
                    Эффективное лазерное лечение купероза и сосудистых звездочек. Безопасно, без повреждения кожи и без длительной реабилитации.
                  </p>
            ...
            <section className="reveal-up opacity-0 flex flex-col items-center max-w-7xl mx-auto w-full relative z-10">
              <div className="text-center mb-16">
                ...
                <h2 className="text-[3rem] sm:text-5xl lg:text-[5rem] font-light text-slate-900 tracking-[-0.04em] leading-[1.0] mb-6">
                  С чем мы <span className="font-serif italic text-slate-400">справляемся</span>
                </h2>
              </div>
            ...
            <section className="reveal-up opacity-0 flex flex-col lg:flex-row gap-12 lg:gap-20 items-center bg-white/60 backdrop-blur-xl border border-white/80 rounded-[3rem] p-8 md:p-12 lg:p-16 shadow-[0_1rem_3rem_-1rem_rgba(0,0,0,0.05)] max-w-7xl mx-auto scroll-glow-item group">
               <div className="w-full lg:w-1/2 flex flex-col items-start gap-6">
                  <span className="text-xs uppercase tracking-widest text-[#60c2ff] font-bold block">— Механизм действия</span>
                  <h2 className="text-[2.5rem] md:text-5xl font-light text-slate-900 leading-tight">
                     Как работает <span className="font-serif italic text-[#60c2ff]">аппаратное удаление</span>
                  </h2>
                  <p className="text-lg md:text-xl text-slate-600 font-light leading-relaxed mt-4">
                     В основе лечения лежит метод <span className="font-medium text-slate-800">селективного фототермолиза</span>. Аппарат <span className="font-medium text-[#60c2ff]">Clearlight IPL</span> излучает мощный световой импульс с точно выверенной длиной волны.
                  </p>
                  <p className="text-lg md:text-xl text-slate-600 font-light leading-relaxed">
                     Этот свет поглощается оксигемоглобином внутри расширенного сосуда. Происходит локальный нагрев, стенки сосуда склеиваются (коагулируются) и он перестает функционировать. Постепенно сосуд полностью рассасывается организмом, а окружающая здоровая кожа остается нетронутой.
                  </p>
               </div>
               <div className="w-full lg:w-1/2 relative rounded-[2.5rem] overflow-hidden aspect-[4/3] lg:h-[500px] shadow-2xl">
                  <ServiceImage src="/images/spider-veins-process-v2.png" alt="Процесс лазерного удаления" sizes="(max-width: 1024px) 100vw, 50vw" className="w-full h-full object-cover md:group-hover:scale-[1.03] transition-transform duration-700" />
               </div>
            </section>
              ...
              <div className="w-full bg-white/60 backdrop-blur-xl border border-white/80 rounded-[3rem] p-10 md:p-16 shadow-[0_2rem_4rem_-1rem_rgba(0,0,0,0.03)] reveal-up opacity-0">
                ...
                <div className="flex flex-col divide-y divide-slate-100">
                  <div className="flex flex-col sm:flex-row justify-between sm:items-center py-6 group hover:px-4 transition-all duration-300 gap-2">
                    <span className="text-lg lg:text-xl font-medium text-slate-800 group-hover:text-[#60c2ff] transition-colors">Удаление сосудов (Нос) — Clearlight IPL</span>
                    <span className="text-xl lg:text-2xl font-light text-slate-900 bg-slate-50 px-5 py-2.5 rounded-full border border-slate-100 shrink-0">6 000 ₽</span>
                  </div>
                  <div className="flex flex-col sm:flex-row justify-between sm:items-center py-6 group hover:px-4 transition-all duration-300 gap-2">
                    <span className="text-lg lg:text-xl font-medium text-slate-800 group-hover:text-[#60c2ff] transition-colors">Удаление сосудов (Лицо полностью) — Clearlight IPL</span>
                    <span className="text-xl lg:text-2xl font-light text-slate-900 bg-slate-50 px-5 py-2.5 rounded-full border border-slate-100 shrink-0">14 900 ₽</span>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="reveal-up opacity-0 flex flex-col lg:flex-row gap-12 lg:gap-20 max-w-7xl mx-auto w-full items-start">
               <div className="w-full lg:w-1/3 sticky top-32">
                 ...
                 <p className="text-lg text-slate-500 font-light mb-8">Собрали для вас ответы на часто задаваемые вопросы об удалении сосудов.</p>
                 <button 
                  onClick={() => typeof window !== 'undefined' && window.dispatchEvent(new Event('open-booking-modal'))}
                 ...
                 <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12 max-w-6xl mx-auto">
                   <div className="flex-1 text-center lg:text-left">
                     ...
                     <p className="text-slate-400 font-light text-lg lg:text-xl mb-12 max-w-lg mx-auto lg:mx-0 leading-relaxed">
                       Оставьте заявку на бесплатную консультацию. Врач проведет осмотр и подберет аппарат для бережного удаления сосудов без следов и боли.
                     </p>
