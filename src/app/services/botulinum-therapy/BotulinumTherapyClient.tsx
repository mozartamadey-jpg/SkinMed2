...
export default function BotulinumTherapyClient() {
  useEffect(() => {
        ...
        <main className="w-full mt-12 sm:mt-16">
          ...
          <section className="mb-6 md:mb-10 reveal-up opacity-0">
            <div className="flex flex-wrap items-center gap-2 text-xs md:text-sm text-slate-500">
              ...
              <Icon icon="mdi:chevron-right" className="text-slate-400" />
              <span className="text-slate-700 font-medium">Ботулинотерапия</span>
            </div>
          </section>
          ...
          <section className="mb-20 md:mb-32 reveal-up opacity-0">
            <div className="relative rounded-[2rem] md:rounded-[3rem] overflow-hidden bg-[#050B14] min-h-[550px] md:min-h-[700px] flex items-center group shadow-[0_2rem_5rem_-1rem_rgba(0,0,0,0.3)]">
              <div className="absolute inset-0 z-0">
                <img src="/images/services/injection/inj_wrinkles_1775859331437.png" alt="Ботулинотерапия" className="w-full h-full object-cover opacity-[0.35] mix-blend-overlay scale-105" />
              ...
              <div className="relative z-20 px-8 py-12 sm:px-12 md:px-16 w-full max-w-4xl">
                ...
                <h1 className="text-4xl md:text-6xl lg:text-[6rem] font-light tracking-[-0.04em] leading-[1.0] text-white mb-6 uppercase drop-shadow-2xl">
                  Ботулино- <br /><span className="font-serif italic text-[#60c2ff]/80">терапия</span>
                </h1>
                <p className="text-lg md:text-xl font-light text-slate-300 mb-8 max-w-2xl leading-relaxed">
                  Эффективная коррекция мимических морщин препаратами <span className="font-medium text-white border-b border-[#60c2ff]/50">Диспорт</span> и <span className="font-medium text-white border-b border-[#60c2ff]/50">Ксеомин</span>. Лоб, межбровье и «гусиные лапки» — от <span className="font-medium text-white">10 500₽</span>.
                </p>
                <div className="flex flex-wrap gap-6 items-center">
                  ...
                  <div className="flex items-center gap-3 px-6 py-4 bg-white/5 backdrop-blur-md rounded-full border border-white/10 text-white font-light">
                    ...
                    <span>Результат через 3−5 дней</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="mb-32 lg:mb-48 relative z-10 max-w-6xl mx-auto">
            <div className="mb-16 reveal-up opacity-0 border-b border-slate-200/50 pb-8">
              ...
              <h2 className="text-[3rem] sm:text-5xl lg:text-[5rem] font-light text-slate-900 tracking-[-0.04em] leading-[1.0] max-w-4xl">
                Как работает <span className="font-serif italic text-slate-400">ботулинотерапия?</span>
              </h2>
            </div>
            <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-20 items-center reveal-up opacity-0">
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-[0_2rem_4rem_-1rem_rgba(0,0,0,0.15)] group aspect-[4/5]">
                <img src="https://optim.tildacdn.com/tild6465-6437-4261-b332-343864646663/-/format/webp/photo.jpg.webp" alt="Ботулинотерапия процесс" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[1s]" />
              </div>
              <div className="flex flex-col gap-6">
                <p className="text-base sm:text-[17px] text-slate-600 font-light leading-relaxed">
                  Ботулинотерапия — это введение микродоз ботулотоксина в мимические мышцы лица. Препарат временно расслабляет мышцы, за счёт чего разглаживаются морщины на лбу, межбровье и в зоне <span className="font-medium text-[#60c2ff]">«гусиных лапок»</span>.
                </p>
                <p className="text-base sm:text-[17px] text-slate-600 font-light leading-relaxed">
                  В клинике «СкинМед» используются безопасные препараты <span className="font-medium text-[#60c2ff]">Диспорт</span> и <span className="font-medium text-[#60c2ff]">Ксеомин</span> — сертифицированные и одобренные для эстетической медицины. Наши врачи-ботулинотерапевты — специалисты с большим опытом точной работы с мимической мускулатурой.
                </p>
                <ul className="space-y-3 mt-4">
                  {["Разглаживание морщин на лбу и межбровье", "Лифтинг бровей и уголков рта", "Коррекция «гусиных лапок» вокруг глаз", "Устранение морщин на шее и декольте", "Лечение бруксизма (напряжённые жевательные мышцы)"].map((item, i) => (
          ...
          <section className="mb-32 lg:mb-48 relative z-10">
            <div className="text-center mb-16 reveal-up opacity-0">
              <span className="block text-xs sm:text-sm font-medium uppercase tracking-[0.2em] text-[#60c2ff] mb-4">— Зоны коррекции</span>
              <h2 className="text-[3rem] sm:text-5xl lg:text-[5rem] font-light text-slate-900 tracking-[-0.04em] leading-[1.0] mb-6">
                Что мы <span className="font-serif italic text-slate-400">корректируем?</span>
              </h2>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 stagger-container">
              {[
                { title: "Лоб", desc: "Горизонтальные морщины", icon: "solar:bolt-linear" },
                { title: "Межбровье", desc: "Вертикальные заломы", icon: "solar:eye-linear" },
                { title: "Гусиные лапки", desc: "Зона вокруг глаз", icon: "solar:star-linear" },
                { title: "Брови", desc: "Лифтинг кончиков", icon: "solar:magic-stick-3-linear" },
                { title: "Нос (bunny lines)", desc: "Морщины на спинке", icon: "solar:heart-linear" },
                { title: "Подбородок", desc: "Ментальная складка", icon: "solar:shield-check-linear" },
                { title: "Жевательные мышцы", desc: "Бруксизм и jawline", icon: "solar:danger-triangle-linear" },
                { title: "Шея и декольте", desc: "Горизонтальные кольца", icon: "solar:pallete-2-linear" },
              ].map((item, index) => (
          ...
          <section className="mb-32 lg:mb-48 relative z-10 reveal-up opacity-0 text-center">
            <div className="max-w-4xl mx-auto rounded-[3rem] overflow-hidden shadow-[0_2rem_5rem_-1rem_rgba(0,0,0,0.1)] border border-white/80 bg-white p-2">
              <video controls className="w-full aspect-video object-cover rounded-[2.5rem]" poster="https://optim.tildacdn.com/tild6465-6437-4261-b332-343864646663/-/format/webp/photo.jpg.webp">
                <source src="https://smasclinicakzn.online/BTAsyte.mp4?dl=0" type="video/mp4" />
              </video>
            </div>
          </section>
          ...
          <section className="mb-32 lg:mb-48 max-w-6xl mx-auto w-full">
            <div className="w-full bg-white/60 backdrop-blur-xl border border-white/80 rounded-[3rem] p-10 md:p-16 shadow-[0_2rem_4rem_-1rem_rgba(0,0,0,0.03)] reveal-up opacity-0">
              ...
              <div className="flex flex-col divide-y divide-slate-100">
                {[
                  { name: 'Коррекция морщин лба и межбровья (Акция!)', price: '10 500₽' },
                  { name: 'Диспорт 1 ед.', price: '180₽' },
                  { name: 'Диспорт от 75 ед. (1 ед.)', price: '140₽' },
                  { name: 'Диспорт 220 ед. (Акция!)', price: '30 800₽' },
                  { name: 'Ксеомин 1 ед.', price: '350₽' },
                  { name: 'Ксеомин от 50 ед. (1 ед.)', price: '300₽' },
                  { name: 'Ксеомин 100 ед.', price: '29 000₽' },
                ].map((price, idx) => (
          ...
          <section className="mb-32 lg:mb-48 max-w-4xl mx-auto px-4 lg:px-8">
            ...
            <div className="flex flex-col gap-4 stagger-container">
              {[
                { q: "Больно ли делать ботулинотерапию?", a: "Практически нет. Используются ультратонкие иглы. Ощущается лёгкое покалывание, которое длится секунды. При необходимости наносится анестезирующий крем." },
                { q: "Когда виден результат?", a: "Первые изменения заметны через 3−5 дней. Максимальный эффект — через 10−14 дней после процедуры." },
                { q: "Как долго длится эффект?", a: "Эффект сохраняется 4−6 месяцев. При регулярном повторении интервалы между процедурами увеличиваются." },
                { q: "Можно ли выглядеть естественно?", a: "Да. Наши врачи работают по принципу «natural look» — мимика сохраняется, убираются только заломы и глубокие морщины." },
                { q: "Чем отличается Диспорт от Ксеомина?", a: "Оба препарата содержат ботулотоксин типа А. Ксеомин не содержит комплексообразующих белков, что снижает риск привыкания. Врач подберёт оптимальный препарат." },
              ].map((item, i) => (
              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12 max-w-6xl mx-auto">
                <div className="flex-1 text-center lg:text-left">
                  <h2 className="text-[3rem] sm:text-5xl lg:text-[5rem] font-light text-white tracking-[-0.04em] leading-[1.0] mb-6">
                    Молодость <br /><span className="font-serif italic text-slate-400">без морщин</span>
                  </h2>
                  <p className="text-slate-400 font-light text-lg mb-12 max-w-lg mx-auto lg:mx-0">Запишитесь на бесплатную консультацию по ботулинотерапии. Мы подберём препарат и дозировку для идеального натурального результата.</p>
